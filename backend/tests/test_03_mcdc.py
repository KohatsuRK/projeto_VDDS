...
# Segundo teste: condição B (score_credito > 600)
# Mantém: A=True (renda=5500), C=False

def test_mcdc_condicao_B_score_determina_resultado():
    """
    Teste B (score > 600) tem impacto independente.
...
# Terceiro teste: condição C (possui_co_garantidor)
...
def test_mcdc_condicao_C_co_garantidor_determina_resultado():
    """
    Teste C (co_garantidor) tem impacto independente.
...
# Quatro teste: condição D (renda_mensal > 3000 com garantidor)
...
def test_mcdc_condicao_D_renda_minima_garantidor_determina_resultado():
    """
    Teste D (renda > 3000 com garantidor) tem impacto independente.
